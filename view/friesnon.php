<?php 
    ...
    // Fetch non-vegetarian fries products
    $res = $obj->allfries('Non-vegetarian');
    ...
    if ($res != null) {
        if (isset($_REQUEST['p_id'])) {
            ...
            if (isset($_SESSION['name'])) {
                ...
                $obj->addtocart($_REQUEST['p_id'], $id['id']);  // Add product to the cart using 'id' instead of 'user_id'
            } else {
...
<div class="container">
    <h2 align="center">Non-Vegetarian French Fries</h2>
    <div class="row mt-5 mb-5 d-flex justify-content-around">
        <?php 
        if (!empty($res) && is_array($res)) {
            // Loop through each non-vegetarian fries product
                    ...
                    <div class="card text-center p-3" style="display: flex; flex-direction: column; justify-content: space-between; height: 100%; width: 100%; max-width: 100%;"> <!-- Ensuring equal height and width for the card -->
                        ...
                        <div class="card-body" style="display: flex; flex-direction: column; justify-content: space-between; flex-grow: 1;">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <a href="friesnon.php?p_id=<?php echo $res[$i]['id']; ?>&username=<?php echo $user ?>&ans=<?php echo $ans ?>" class="btn btn-outline-danger mt-3">Add</a>
                            </div>
                        </div>
                    </div>
                </div>
